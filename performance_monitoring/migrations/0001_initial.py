...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('meetings', '0005_draftemail_alter_crmsyncrecord_crm_system_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['alert_type', 'is_active'], name='performance_alert_t_61a902_idx'), models.Index(fields=['severity', 'is_active'], name='performance_severit_b5cbc1_idx'), models.Index(fields=['component', 'is_active'], name='performance_compone_1f3396_idx'), models.Index(fields=['first_occurred'], name='performance_first_o_4a04c7_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['metric_type', 'is_active'], name='performance_metric__d54305_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['timestamp'], name='performance_timesta_6d27e9_idx'), models.Index(fields=['active_calls'], name='performance_active__9981fd_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['operation_type', 'timestamp'], name='performance_operati_982951_idx'), models.Index(fields=['processing_time'], name='performance_process_4b05f1_idx'), models.Index(fields=['confidence_score'], name='performance_confide_761711_idx'), models.Index(fields=['error_occurred', 'timestamp'], name='performance_error_o_198e8e_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['metric_type', 'timestamp'], name='performance_metric__735cb3_idx'), models.Index(fields=['metric_name', 'timestamp'], name='performance_metric__c0d2fd_idx'), models.Index(fields=['status', 'timestamp'], name='performance_status_59b583_idx'), models.Index(fields=['timestamp'], name='performance_timesta_734bcf_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['connection_success', 'created_at'], name='performance_connect_841944_idx'), models.Index(fields=['transcription_accuracy'], name='performance_transcr_32f162_idx'), models.Index(fields=['error_count'], name='performance_error_c_74c3e3_idx')],
            },
        ),
    ]
