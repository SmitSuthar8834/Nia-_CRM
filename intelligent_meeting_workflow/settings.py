"""
Django settings for intelligent_meeting_workflow project.
...
WSGI_APPLICATION = 'intelligent_meeting_workflow.wsgi.application'
ASGI_APPLICATION = 'intelligent_meeting_workflow.asgi.application'
...
if 'test' in sys.argv:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='intelligent_meeting_workflow'),
...
CREATIO_USERNAME = config('CREATIO_USERNAME', default='')
CREATIO_PASSWORD = config('CREATIO_PASSWORD', default='')
